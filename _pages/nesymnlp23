---
title: "BLAST - Teaching: Neuro-Symbolic NLP"
layout: gridlay
excerpt: "BLAST -- Teaching: Neuro-Symbolic NLP"
sitemap: false
permalink: /teaching/nesymnlp23
---
...
Each student should expect to present one research paper during the course. The instructor will
ask students to sign up for papers by the end of the first day of class. The instructor
will present any unselected papers during the course.
...
- **Share**. After students talk in pairs for a few minutes, the presenter or instructor
will call for pairs to SHARE their thinking with the rest of the class.

#### Course Project

Students are expected to work on a course project either alone or in groups (no more than 3
students in a group). There are two options for projects: 
...
The proposal should be no longer than 2 pages (minus references) and include the following sections:
   ...
   2. **Introduction** section, which should explain the context of the paper. It should contain the following information:<br>
      1. _Task / Research Question Description_: For research projects, what is the task you are trying to solve or what is the research question you are trying to answer? For reproduction studies, what does the original paper propose and which claims are you wanting to verify?<br>
...
For more information, see the [classroom behavior policy](https://www.colorado.edu/policies/student-classroom-course-related-behavior), the [Student Code of Conduct](https://www.colorado.edu/sccr/student-conduct), and the [Office of Institutional Equity and Compliance](https://www.colorado.edu/oiec/).
...
Free and unlimited telehealth is also available through Academic Live Care. The [Academic Live Care](https://www.colorado.edu/health/academiclivecare) site also provides information about additional wellness services on campus that are available to students.
